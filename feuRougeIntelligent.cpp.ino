/*
 * ============================================================
 * TP : Carrefour Intelligent à base d'Arduino
 * Entrée utilisateur : Port Série (PC)
 * Affichage : 1 seul LCD I2C 16x2 (rétroéclairage permanent)
 * Voies simulées : NORD, EST, SUD, OUEST (ordre horaire)
 *
 * VERSION 5 :
 *  - Nouveau menu "10" : etat simultane des 3 autres voies
 *    (voie, etat du feu, nb vehicules) sur une seule ligne LCD.
 *  - Detection speciale "1"+"0" = "10" (sans casser le "1" seul).
 * ============================================================
 */
